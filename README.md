...
| `mordred_features_cached.csv` | Precomputed Mordred descriptor matrix for UniTox (2,196 × 1,613) |

> `mordred_withdrawn_cached.csv` is not included. Run `003_mordred_feature_computation.py` to generate it.
